...
// import terrainGenerationUtils from 'terrain-generator/src';
// import utils from '../../src/utils';


// console.log(Walk);
// // console.log(Walk.default);
// // console.log(require.context('./Player/Walk', false, /\.(png|jpe?g|svg)$/))
// // console.log(utils.importImages('./Player/Walk'))
// setupGame();
